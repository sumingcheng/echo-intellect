...
from config.settings import get_llm_providers, get_default_llm
...
class QueryExpander:
    ...
    def initialize(self):
        ...
        try:
            ...
            model = get_default_llm() or "gpt-4o-mini"
            ...
            logger.info("查询扩展器初始化成功，使用模型: %s", model)
